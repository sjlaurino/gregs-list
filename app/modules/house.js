export default class House {
  constructor(data) {
    ...
    this.imgUrl = data.imgUrl || "https://place-hold.it/300x500?text=House%20Pic%20Here"
  ...
  <div class="card col-3 mx-3 mt-5">
      ...
      <div class="card-body">
        ...
        <p>${this.description}</p>
         <button onclick="app.controllers.houseController.removeHouse('${this._id}')" type="button" class="btn btn-outline-danger">Delete House</button>
      </div>
  </div>
    `
  }
